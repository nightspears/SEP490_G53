...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__areas__3213E83FFFD32546");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__CD65CB8542D5C934");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Feedback__3214EC27FE668442");
            ...
            entity.HasOne(d => d.Creator).WithMany(p => p.Feedbacks)
                ...
                .HasConstraintName("FK__Feedback__creato__6EF57B66");

            entity.HasOne(d => d.Responder).WithMany(p => p.Feedbacks)
                .HasForeignKey(d => d.ResponderId)
                .HasConstraintName("FK__Feedback__respon__6FE99F9F");
        });

        modelBuilder.Entity<Match>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Matches__3213E83F0FDC460D");
        ...
        {
            entity.HasKey(e => new { e.MatchId, e.AreaId }).HasName("PK__Match_Ar__34FA1D753C0BA3E5");
            ...
            entity.HasOne(d => d.Area).WithMany(p => p.MatchAreaTickets)
                ...
                .HasConstraintName("FK__Match_Are__area___70DDC3D8");

            entity.HasOne(d => d.Match).WithMany(p => p.MatchAreaTickets)
                .HasForeignKey(d => d.MatchId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Match_Are__match__71D1E811");
        });

        modelBuilder.Entity<News>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__News__3213E83FA3AC8530");
            ...
            entity.HasOne(d => d.Creator).WithMany(p => p.News)
                .HasForeignKey(d => d.CreatorId)
                .HasConstraintName("FK__News__creator_id__72C60C4A");

            entity.HasOne(d => d.NewsCategory).WithMany(p => p.News)
                .HasForeignKey(d => d.NewsCategoryId)
                .HasConstraintName("FK__News__news_categ__73BA3083");
        });

        modelBuilder.Entity<NewsCategory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__News_Cat__3213E83F7B9C83BF");
            ...
            entity.HasOne(d => d.Creator).WithMany(p => p.NewsCategories)
                .HasForeignKey(d => d.CreatorId)
                .HasConstraintName("FK__News_Cate__creat__74AE54BC");
        });

        modelBuilder.Entity<OrderProduct>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Order_Pr__3213E83F43C89ECC");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.OrderProducts)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK__Order_Pro__custo__76969D2E");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Ordered___3213E83F035C4B36");
            ...
            entity.HasOne(d => d.Item).WithMany(p => p.OrderedSuppItems)
                ...
                .HasConstraintName("FK__Ordered_s__item___7A672E12");

            entity.HasOne(d => d.Order).WithMany(p => p.OrderedSuppItems)
                .HasForeignKey(d => d.OrderId)
                .HasConstraintName("FK__Ordered_s__order__7B5B524B");
        });

        modelBuilder.Entity<OrderedTicket>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Ordered___3213E83F3678944E");
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.OrderedTickets)
                .HasForeignKey(d => d.OrderId)
                .HasConstraintName("FK__Ordered_t__order__7E37BEF6");
        });

        modelBuilder.Entity<Payment>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Payments__3213E83F499F90EA");
            ...
            entity.HasOne(d => d.OrderTicket).WithMany(p => p.Payments)
                ...
                .HasConstraintName("FK__Payments__order___7F2BE32F");
        });

        modelBuilder.Entity<Player>(entity =>
        {
            entity.HasKey(e => e.PlayerId).HasName("PK__Players__44DA120C93FA9135");
            ...
            entity.HasOne(d => d.Season).WithMany(p => p.Players)
                ...
                .HasConstraintName("FK__Players__season___01142BA1");
        });

        modelBuilder.Entity<Product>(entity =>
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__47027DF53ECFB3E9");
            ...
            entity.HasOne(d => d.Season).WithMany(p => p.Products)
                .HasForeignKey(d => d.SeasonId)
                .HasConstraintName("FK__Product__season___03F0984C");
        });

        modelBuilder.Entity<ProductCategory>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__product___D54EE9B4F248687D");
        ...
        {
            entity.HasKey(e => e.FileId).HasName("PK__Product___07D884C65DE1FAD6");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductFiles)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__Product_f__produ__04E4BC85");
        });

        modelBuilder.Entity<Profile>(entity =>
        {
            entity.HasKey(e => e.ProfileId).HasName("PK__profile__AEBB701F1D85B3FF");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Profiles)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK__profile__custome__05D8E0BE");
        });

        modelBuilder.Entity<Role>(entity =>
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CC84A8A0D3");
        ...
        {
            entity.HasKey(e => e.SeasonId).HasName("PK__Seasons__0A99E33183F56AD1");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__Suppleme__52020FDDC05A29F5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Ticket_O__3213E83FBF24EB1A");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.TicketOrders)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK__Ticket_Or__custo__07C12930");
        });

        modelBuilder.Entity<User>(entity =>
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__B9BE370F69DE29A6");

            entity.HasIndex(e => e.Email, "UQ__Users__AB6E616416E430C0").IsUnique();
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Users)
                ...
                .HasConstraintName("FK__Users__role_id__08B54D69");
        });
