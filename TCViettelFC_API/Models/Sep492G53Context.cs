...
public partial class Sep492G53Context : DbContext
{
    public Sep492G53Context()
    {
    }

    public Sep492G53Context(DbContextOptions<Sep492G53Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=Quan;Initial Catalog=SEP492_G53;User ID=sa;Password=11122002;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__areas__3213E83F47CE3BB5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Feedback__3214EC2713DF7742");
            ...
            entity.HasOne(d => d.Responder).WithMany(p => p.Feedbacks)
                ...
                .HasConstraintName("FK__Feedback__respon__74AE54BC");
        });

        modelBuilder.Entity<Match>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Matches__3213E83FD7B05E21");
        ...
        {
            entity.HasKey(e => new { e.MatchId, e.AreaId }).HasName("PK__Match_Ar__34FA1D755ECA9215");
            ...
            entity.HasOne(d => d.Area).WithMany(p => p.MatchAreaTickets)
                ...
                .HasConstraintName("FK__Match_Are__area___75A278F5");

            entity.HasOne(d => d.Match).WithMany(p => p.MatchAreaTickets)
                .HasForeignKey(d => d.MatchId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Match_Are__match__76969D2E");
        });

        modelBuilder.Entity<News>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__News__3213E83F22917907");
            ...
            entity.HasOne(d => d.Creator).WithMany(p => p.News)
                .HasForeignKey(d => d.CreatorId)
                .HasConstraintName("FK__News__creator_id__778AC167");

            entity.HasOne(d => d.NewsCategory).WithMany(p => p.News)
                .HasForeignKey(d => d.NewsCategoryId)
                .HasConstraintName("FK__News__news_categ__787EE5A0");
        });

        modelBuilder.Entity<NewsCategory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__News_Cat__3213E83F79F79F66");
            ...
            entity.HasOne(d => d.Creator).WithMany(p => p.NewsCategories)
                .HasForeignKey(d => d.CreatorId)
                .HasConstraintName("FK__News_Cate__creat__797309D9");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Ordered___3213E83FDCC1097A");
            ...
            entity.HasOne(d => d.Item).WithMany(p => p.OrderedSuppItems)
                ...
                .HasConstraintName("FK__Ordered_s__item___7F2BE32F");

            entity.HasOne(d => d.Order).WithMany(p => p.OrderedSuppItems)
                .HasForeignKey(d => d.OrderId)
                .HasConstraintName("FK__Ordered_s__order__00200768");
        });

        modelBuilder.Entity<OrderedTicket>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Ordered___3213E83F80A22F3A");
            ...
            entity.HasOne(d => d.Area).WithMany(p => p.OrderedTickets)
                .HasForeignKey(d => d.AreaId)
                .HasConstraintName("FK__Ordered_t__area___01142BA1");

            entity.HasOne(d => d.Match).WithMany(p => p.OrderedTickets)
                .HasForeignKey(d => d.MatchId)
                .HasConstraintName("FK__Ordered_t__match__02084FDA");

            entity.HasOne(d => d.Order).WithMany(p => p.OrderedTickets)
                .HasForeignKey(d => d.OrderId)
                .HasConstraintName("FK__Ordered_t__order__02FC7413");
        });

        modelBuilder.Entity<Payment>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Payments__3213E83F1A04BE68");
        ...
        {
            entity.HasKey(e => e.PlayerId).HasName("PK__Players__44DA120CE1322F32");
            ...
            entity.HasOne(d => d.Season).WithMany(p => p.Players)
                ...
                .HasConstraintName("FK__Players__season___06CD04F7");
        });

        modelBuilder.Entity<Product>(entity =>
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__47027DF5B2499C43");
            ...
            entity.HasOne(d => d.Season).WithMany(p => p.Products)
                .HasForeignKey(d => d.SeasonId)
                .HasConstraintName("FK__Product__season___09A971A2");
        });

        modelBuilder.Entity<ProductCategory>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__product___D54EE9B4C2BD5187");
        ...
        {
            entity.HasKey(e => e.FileId).HasName("PK__Product___07D884C682147BEC");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductFiles)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__Product_f__produ__0A9D95DB");
        });

        modelBuilder.Entity<Profile>(entity =>
        {
            entity.HasKey(e => e.ProfileId).HasName("PK__profile__AEBB701F672570B8");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CC67F85B3E");
        ...
        {
            entity.HasKey(e => e.SeasonId).HasName("PK__Seasons__0A99E331314F75DA");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__Suppleme__52020FDD98448DB1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Ticket_O__3213E83F17F04DB9");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__B9BE370F9572BD33");

            entity.HasIndex(e => e.Email, "UQ__Users__AB6E616452E57C41").IsUnique();
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Users)
                ...
                .HasConstraintName("FK__Users__role_id__0E6E26BF");
        });
